...
{#each keywords as kw, i}
	{#if [
		...
		<div class="logo-chip" style={`--delay: ${i * 70}ms`}>
			{#if kw === 'Unity3D'}
				<DiUnitySmall />
			{:else if kw === 'C#'}
				<img src={'/images/hashtag.png'} alt="C# logo" />
			{:else if kw === 'MySQL'}
				<DiMysql />
			{:else if kw === 'Java'}
				<DiJava />
			{:else if kw === 'Firebase'}
				<DiFirebase />
			{:else if kw === 'Spring Boot'}
				<img src={'/images/springboot.png'} alt="springboot logo" />
			...
			{:else if kw === 'NodeJS'}
				<DiNodejsSmall />
			{:else if kw === 'Tailwind'}
				<img src={'/images/tailwind-css.svg'} alt="Tailwindcss logo" />
			{:else if kw === 'HTML'}
				<DiHtml5 />
			{:else if kw === 'C++'}
				<img src={'/images/cPlusPlusIcon.png'} alt="C++ icon from Freepik" />
			{:else if kw === 'JSON'}
				<img src={'/images/json.png'} alt="json logo" />
			{:else if kw === 'Multilingual'}
				<img src={'/images/language.png'} alt="multilingual icon from Freepik" />
			{:else if kw === 'Multiplayer'}
